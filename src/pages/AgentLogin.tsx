...
export default function AgentLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Agents log in with 'admin' role in this system architecture
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020617] px-4 py-12 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md shadow-2xl border-white/10 bg-[#0F172A] relative z-10">
        <CardHeader className="text-center pb-6 border-b border-white/10">
          ...
          <div className="h-12 w-12 bg-blue-500/10 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-blue-500/20">
            <Landmark className="h-6 w-6 text-blue-400" />
          </div>
          <h1 className="font-heading font-black text-2xl text-white">Agent / Admin Portal</h1>
          <p className="text-sm text-[#94A3B8] mt-2">Secure access for verified agents and administrators</p>
        </CardHeader>
        <CardContent className="pt-8">
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 mb-6">
            <p className="text-xs text-blue-200 leading-relaxed font-medium">
              ...
              <Link to="/admin/register" className="text-blue-400 font-black hover:underline underline-offset-2">Apply for a Government License</Link> here.
            </p>
          </div>

          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-[#94A3B8] text-xs font-bold uppercase tracking-wider">Email Address</Label>
              <Input
                id="email"
                type="email"
                value={email}
                ...
                required
                className="bg-[#020617] border-white/10 text-white focus:border-blue-500/50 h-12"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="••••••••"
                  required
                  className="bg-[#020617] border-white/10 text-white focus:border-blue-500/50 h-12 pr-10"
                />
                <button
                  type="button"
            ...
            <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 text-sm shadow-lg shadow-blue-900/20" disabled={loading}>
